...
import UserRegistration from './UserRegistration'; // Asegúrate de que la ruta sea correcta
...
const Login: React.FC = () => {
  ...
  const [showRegister, setShowRegister] = useState(false); // 👈 Estado para el formulario de registro
  ...
  return (
    <>
      ...
      {/* Mostrar modal de registro si showRegister es true */}
      {showRegister && (
        <UserRegistration
